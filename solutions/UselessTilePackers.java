...
// I borrowed the Geometry Class from course website
...
public class Main {
	...
	public static void main(String[] args) throws IOException{
		...
		while(scan.hasNext()) {
			...
			double innerArea = area(al);
			double convexArea = area(chull(al));
			double waste = convexArea - innerArea;
//			System.out.println(innerArea + " " + convexArea);
			System.out.println("Tile #" + counter++);
			System.out.printf("Wasted Space = %.2f %%\n", (waste/convexArea) * 100);
			System.out.println();
		}
	}
